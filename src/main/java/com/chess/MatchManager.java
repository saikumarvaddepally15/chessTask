...
public class MatchManager {
    public void calculateTotalPoints(int roundNumber,int tournamentID){
        ...
        String query="select *from GAME where ROUND_NUMBER="+roundNumber+" and TOURNAMENT_ID="+tournamentID;
    ...
    public void updateTotalPointsInDB(int playerID,int points,int tournamentID,DatabaseConnection databaseConnection){
        ...
        String query="update PLAYERS_IN_TOURNAMENT set TOTAL_POINTS="+(points+totalPointsOfPlayer)+" where PLAYER_ID="+playerID+" and TOURNAMENT_ID="+tournamentID;
