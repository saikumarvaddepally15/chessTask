...
public class PairingManager {
    ...
    public List<Match> pairing(int tournamentId,int roundNumber){
        ...
        String query="select *from USER u,PLAYERS_IN_TOURNAMENT p where p.TOURNAMENT_ID="+tournamentId+" and u.PLAYER_ID=p.PLAYER_ID order by TOTAL_POINTS desc";
...
//                " where PLAYERID="+playerId;
        ...
        String query="update GAME set RESULT='"+result+"',PLAYER1_POINTS="+player1Points+",PLAYER2_POINTS="+player2Points+" where PLAYER1_ID="+player1ID+" and PLAYER2_ID="+player2ID
...
//        System.out.println(query);
    ...
    public List<Match> paired(int tournamentId,int roundNumber){
        String query="select *from USER u,GAME g where g.ROUND_NUMBER="+roundNumber+" and TOURNAMENT_ID="+tournamentId+" and u.PLAYER_ID=g.PLAYER1_ID";
        String query2="select *from USER u,GAME g where g.ROUND_NUMBER="+roundNumber+" and TOURNAMENT_ID="+tournamentId+" and u.PLAYER_ID=g.PLAYER2_ID";
